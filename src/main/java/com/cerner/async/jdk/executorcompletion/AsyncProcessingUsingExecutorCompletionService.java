package com.cerner.async.jdk.executorcompletion;
 ...
 * @author bogdan.solga
 */
public class AsyncProcessingUsingExecutorCompletionService {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        final List<Integer> productStocks = new ArrayList<>(depositIds.size());
        try {
    ...
    /**
     * The product processor simulates the querying of several deposits for their stock of {@link com.cerner.async.model.Product}s
     */
